...
export default function DecisionHistory() {
  ...
  function confirmDelete() {
    ...
    const analysisName =
      deleteTarget.context?.analysis_name ||
      "Untitled Analysis";
    ...
    const updatedHistory = history.filter(
      (historyItem) => {
        ...
        return historyItem !== deleteTarget;
      }
    );
    ...
    setToast({
      ...
      message: `"${analysisName}" was removed from Decision History.`,
    });
  ...
  function confirmClearHistory() {
    ...
    setToast({
      ...
      message:
        "All saved decisions were removed from Decision History.",
    });
...
function HistoryStat({
  ...
  return (
    <button
      type="button"
      className={`history-stat-card history-stat-interactive ${
        active ? "history-stat-active" : ""
      }`}
      onClick={onClick}
    >
      <div>
